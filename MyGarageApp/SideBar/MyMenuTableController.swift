...
class MyMenuTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        //tableView.deselectRow(at: IndexPath(row: selectedMenuItem, section: 0), animated: false)
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if (cell == nil) {
            ...
            cell!.textLabel?.textColor = UIColor(hex: "9c6f24") //UIColor.darkGray
            cell?.textLabel?.font = UIFont(name: "Palatino", size: 17.0) //UIFont(name: "Palatino", style: "Regular", size: 17.0)
            let selectedBackgroundView = UIView(frame: CGRect(x: 0, y: 0, width: cell!.frame.size.width, height: cell!.frame.size.height))
            selectedBackgroundView.backgroundColor = UIColor.gray.withAlphaComponent(0.2)
            cell!.selectedBackgroundView = selectedBackgroundView
        }
        
        cell!.textLabel?.text = sezioni[indexPath.row]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 0:
            destViewController = mainStoryboard.instantiateViewController(withIdentifier: "listOfCars")
            break
        case 1:
            destViewController = mainStoryboard.instantiateViewController(withIdentifier: "autoMemo")
            break
        case 2:
